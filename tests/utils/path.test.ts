...
import { isSupported, getExtension, isImageFile, getSingleOutputPath, getFolderOutputPath } from "../../src/utils/path.js";
...
describe("getFolderOutputPath", () => {
  ...
  it("should use output arg dir and keep original name", () => {
    const result = getFolderOutputPath(inputBase, "/project/images/photo.png", "/build");
  ...
  it("should preserve subdirectory structure in output dir with original name", () => {
    const result = getFolderOutputPath(inputBase, "/project/images/sub/folder/photo.png", "/build");
